...
> **Study by fighting. Fight by studying.**  
...
StudyBuddy is a desktop/web game I built to make revision feel like something worth doing. Instead of reading flashcards, you explore a procedural world, face enemies that test your knowledge, and survive using what you've learned. The harder the question, the harder the enemy hits back.
...
![StudyBuddy Combat Screen](static/index.html)

**Run it yourself:**
```bash
# Clone and run (Python 3.11+)
git clone https://github.com/HeisLazi/StudyBuddy.git
cd StudyBuddy
...
│   ├── GAME_STORY.md
│   └── NEXT_STEPS.md
├── STUDYBUDDY_SUBJECT_TEMPLATE.json  # Template for creating new subjects
├── StudyBuddy.spec                   # PyInstaller build spec
...
*StudyBuddy was built as a personal project to make revision less terrible. It's also what I give to interviewers when they ask if I have any side projects.*
