"""
launcher.py — StudyBuddy: The Unbound  ·  Desktop Launcher
...
try:
    ...
    print(
        "\n[StudyBuddy Launcher] pywebview is not installed.\n"
...
<html>
<head><meta charset="utf-8"><title>StudyBuddy — Loading</title></head>
<body style="
  background:#07040f;
  margin:0; padding:0;
...
">
  <div style="color:#9a70cc;font-size:42px;margin-bottom:18px;letter-spacing:4px">⚡ StudyBuddy</div>
